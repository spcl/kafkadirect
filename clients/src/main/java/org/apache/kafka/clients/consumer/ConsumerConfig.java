...
public class ConsumerConfig extends AbstractConfig {
    ...
    /**
     * <code>measure.latency/code>
     */
    public static final String MEASURE_LATENCY_CONFIG = "measure.latency";
    private static final String MEASURE_LATENCY_DOC = "measure latency of each fetch request.";
